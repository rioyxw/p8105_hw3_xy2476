...
# We can see from the table that usually the participant has an average activity count around 400000. The first day of the first week has the least amount of activity count for that week. Week four and five's weekend have the least amount of activity. Saturdays in general have the least sum of activity count. 
```
