...
min), 4:30pm(1000th min), and around 9pm(1250th min). 10 am cluster
usually happens on Sundays, 4:30pm one usually happens on Saturday and
Sunday, and 9pm one usually happens on Tuesdays, Wednesdays, Fridays and
Saturdays. These may indicate that the participant is more active during
the nights across all days, but tries to be more active in the morning
or the afternoon during the weekends.
